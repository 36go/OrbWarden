...
// Single-gradient progress bar style: true blueâ†’green color blend, no transparency tricks
  ...
  >
            ...
            <div class="flex flex-wrap items-center gap-2">
              <Badge
                ...
                :class="[
                  ...
                  questType === 'stream' && 'border-blue-400/60 bg-blue-500/10 text-blue-600 dark:text-blue-400',
                  questType === 'activity' && !isCloudGameActivity && 'border-amber-400/60 bg-amber-500/10 text-amber-600 dark:text-amber-400',
                  isCloudGameActivity && 'border-blue-400/60 bg-blue-500/10 text-blue-600 dark:text-blue-400',
                ]"
              >
            ...
            <CardTitle :class="density === 'compact' ? 'truncate text-base text-primary sm:text-lg' : 'text-xl text-primary'">
              <template v-if="density === 'compact'">
                ...
                <span v-if="quest.config.messages.game_title" class="font-normal text-muted-foreground">
                  Â· {{ quest.config.messages.game_title }}
                </span>
              </template>
              <template v-else>
                {{ quest.config.messages.quest_name }}
    ...
    <CardContent :class="density === 'compact' ? 'grid gap-3' : 'grid gap-4'">
      ...
      <div class="space-y-2">
        ...
        <!-- Progress Bar for Active Quest: single gradient div, blueâ†’green -->
